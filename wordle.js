 ...
 */
 ...
 var listaPalabras = ['abajo', 'ayuda', 'llora', 'fecha', 'raton', 'lugar'];
 ...
 **************************************************************/
 ...
 function haGanado() {
     ...
     if (palabra == palabraBuscada){
         ...
         mensajeGanador = mensajeGanador + '<h2 class= "alert alert-warning text-center" role="alert"> Ingrese sus credenciales <input>';
 ...
 **************************************************************/
 ...
 function haPerdido(){
     ...
     mensajePerdedor = mensajePerdedor + '<h2 class= "alert alert-warning text-center" role="alert"> Ingrese sus credenciales <input> ';
